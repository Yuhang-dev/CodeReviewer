...
def review_pipeline_job(repo_full_name: str, pr_number: int, commit_id: str, tier: str = "Tier-B",
                        review_context: str = "", review_focus: str = ""):
    ...
    try:
        ...
        if global_warning:
            run_async(post_pr_comment(repo_full_name, pr_number,
                                      f"⚠️ **Global Impact Warning ( {tier} )** ⚠️\n\n{global_warning}"))
